                ...
                <div className="md:col-span-3 flex flex-col justify-center">
                    <div className="bg-white p-6 rounded-xl border-1 border-gray-300">
                        ...
                        <div className="flex justify-center mt-6">
                            <label
                                htmlFor="file-upload"
                                className="px-6 py-3 bg-blue-900 text-white rounded-lg font-medium hover:bg-blue-800 transition-colors duration-300 cursor-pointer flex items-center shadow"
