  ...
  return (
    ...
    <div>
      ...
      <form className="space-y-4">
        <div>
          <label className="block text-sm font-medium" htmlFor="emailOrUsername">Correo electrónico o nombre de usuario</label>
          <input
            id="emailOrUsername"
            type="text"
            placeholder="correo@ejemplo.com o username"
            className="w-full p-2 mt-1 border-2 rounded-lg focus:outline-none focus:ring-1 focus:border-blue-500 focus:ring-blue-500"
          />
        </div>

        <div>
          <label className="flex justify-between text-sm font-medium" htmlFor="password">
            Contraseña
        ...
        <button className="w-full p-2 font-semibold text-white bg-blue-900 rounded-lg hover:bg-blue-800">Iniciar sesión</button>
      </form>

      <p className="text-sm mt-7 mb-7 text-center">
        ¿No tienes una cuenta? <a href="#" className="text-blue-900 font-bold no-underline link-underline">Registrarme</a>
      </p>

      <div className="relative flex items-center justify-center my-4">
        <span className="absolute px-4 bg-white text-sm">or</span>
